      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse">
              <ul class="nav navbar-nav navbar-right">
                  <li>
                      <a class="page-scroll intro-btn" href="#intro">Początek</a>
                  </li>
                  <li>
                      <a class="page-scroll how-works-btn" href="#how-works">Jak to działa?</a>
                  </li>
                  <li>
                      <a class="page-scroll program-languages-btn" href="#program-languages">Języki</a>
                  </li>
                  <li>
                      <a class="page-scroll about-project-btn" href="#about-project">O projekcie</a>
                  </li>
                  <li>
                      <a class="page-scroll faq-btn" href="faq.html">FAQ</a>
                  </li>
              </ul>
          </div>
      </div>
...
<footer>
    <div class="container">
        <p>Copyright &copy; Jaki Język Programowania 2017</p>
    </div>
</footer>

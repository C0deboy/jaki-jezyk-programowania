  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <h1 class="navbar-brand site-logo">
        <a href="https://www.jaki-jezyk-programowania.pl/">
...
<section id="jak-to-dziala" class="section">
  <div class="container">
    ...
    <p>
      Przygotowaliśmy dla Ciebie zbiór pytań, dzięki którym jesteśmy w stanie określić język programowania (lub więcej niż jeden) pasujący do Twoich wymagań. Projekt powstał, aby rozwiać wszelkie wątpliwości początkujących programistów, jak i doradzić w wyborze języka osobom chcącym doświadczyć czegoś nowego. Kliknij start, a sam dowiesz się jaki język pasuje dla Ciebie najbardziej! Jeśli masz dodatkowe pytania warto przejrzeć FAQ, gdzie zebraliśmy wiele fundamentalnych pytań!
    </p>
...
<section id="o-projekcie" class="section about-project">
  <div class="container">
    ...
    <p class="row">
      Masz jakieś uwagi czy zastrzeżenia? A może masz sugestię, którą chciałbyś się z nami podzielić? Czekamy na twoją opinię, która na pewno zmotywuje nas do dalszej pracy!
    </p>

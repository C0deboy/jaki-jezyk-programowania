...
var languagesExamples = [
  ...
  'C++<br><span class="function-highlighter">void</span> <span class="function-name-highlighter">divide</span>(<span class="keyword-highlighter">int</span> <span class="function-arg-highlighter">a</span>, <span class="keyword-highlighter">int</span> <span class="function-arg-highlighter">b</span>) {<br><span style="margin-left: 2em;"> <span class="keyword-highlighter">if</span> (b <span class="keyword-highlighter">==</span> <span class="number-highlighter">0</span>) <span class="keyword-highlighter">cout</span> << <span class="string-highlighter">"Warning"</span> << <span class="keyword-highlighter">endl</span>;</span><br><span style="margin-left: 2em"><span class="keyword-highlighter">else</span> <span class="keyword-highlighter">cout</span> << a <span class="keyword-highlighter">/</span> b << <span class="keyword-highlighter">endl</span>; <br>}<br><span class="function-name-highlighter">divide</span>(<span class="number-highlighter">15</span>, <span class="number-highlighter">5</span>);<br><span class="number-highlighter">3</span>',
  'Java<br><span class="keyword-highlighter">public static</span> <span class="function-highlighter">String</span> <span class="function-name-highlighter">divide</span>(<span class="function-highlighter">int</span> <span class="function-arg-highlighter">a</span>, <span class="function-highlighter">int</span> <span class="function-arg-highlighter">b</span>) {<br><span style="margin-left: 2em;"> <span class="keyword-highlighter">if</span> (b <span class="keyword-highlighter">==</span> <span class="number-highlighter">0</span>) <span class="keyword-highlighter">return</span> <span class="string-highlighter">"Warning";</span></span><br><span style="margin-left: 2em"><span class="keyword-highlighter">else return</span> <span class="function-highlighter">String</span><span class="keyword-highlighter">.</span><span class="function-name-highlighter">valueOf</span>(a <span class="keyword-highlighter">/</span>b);</span> <br>}<br><span class="keyword-highlighter">System.out.print</span>(<span class="function-name-highlighter">divide</span>(<span class="number-highlighter">15</span>, <span class="number-highlighter">5</span>));<br><span class="number-highlighter">3</span>',
  ...
  'C<br><span class="function-highlighter">void</span> <span class="function-name-highlighter">divide</span>(<span class="keyword-highlighter">int</span> <span class="function-arg-highlighter">a</span>, <span class="keyword-highlighter">int</span> <span class="function-arg-highlighter">b</span>) {<br><span style="margin-left: 2em;"> <span class="keyword-highlighter">if</span> (b <span class="keyword-highlighter">==</span> <span class="number-highlighter">0</span>) <span class="keyword-highlighter">printf</span>(<span class="string-highlighter">"Warning/n"</span>);<br><span style="margin-left: 2em"><span class="keyword-highlighter">else </span><span class="keyword-highlighter">printf</span>(<span class="string-highlighter">"%d"</span>, a <span class="keyword-highlighter">/</span> b);</span> <br>}<br><span class="function-name-highlighter">divide</span>(<span class="number-highlighter">15</span>, <span class="number-highlighter">5</span>);<br><span class="number-highlighter">3</span>',
  ...
  'C#<br>public <span class="function-highlighter">string</span> <span class="function-name-highlighter">divide</span>(<span class="keyword-highlighter">int</span> <span class="function-arg-highlighter">a</span>, <span class="keyword-highlighter">int</span> <span class="function-arg-highlighter">b</span>) {<br><span style="margin-left: 2em;"> <span class="keyword-highlighter">if</span> (b <span class="keyword-highlighter">==</span> <span class="number-highlighter">0</span>) <span class="keyword-highlighter">return</span> <span class="string-highlighter">"Warning";</span></span><br><span style="margin-left: 2em"><span class="keyword-highlighter">else return</span> (a <span class="keyword-highlighter">/</span> b).<span class="keyword-highlighter">ToString</span>(); <br>}<br><span class="keyword-highlighter">Console.WriteLine</span>(<span class="function-name-highlighter">divide</span>(<span class="number-highlighter">15</span>, <span class="number-highlighter">5</span>));<br><span class="number-highlighter">3</span>',
